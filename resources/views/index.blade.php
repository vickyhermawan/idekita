...
<html lang="en">
	<head>
		...
		<title>Tempat Sharing Ide Terlengkap - IdeKita.net</title>
	...
	<body>
		...
		<div id="home" class="hero-area">
			...
			<div class="home-wrapper">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h1 class="white-text" >Terupdate, Mudah, Inovatif </h1>
							<p class="lead white-text">temukan partner kerjamu sekarang! </p>
		...
		<nav> 
			<ul>
				<li> 
				<center><a href="#">Ide Paling Disukai</a></center>
				</li>
			</ul>
		</nav>
		</div>
